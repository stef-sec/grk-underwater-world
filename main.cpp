...
static GLint g_uTerrainBaseColor = -1;
...
static void initPrograms() {
    ...
    g_uTerrainBaseColor = glGetUniformLocation_(g_terrainProgram, "uBaseColor");
...
static void renderFrame() {
    ...
    beginShadowPass(g_shadow, lightVP);
    ...
    glUniform3f_(g_uTerrainBaseColor, 0.42f, 0.36f, 0.24f);
